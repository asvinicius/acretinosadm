...
<html lang="en">
  <head>
    ...
    <title>SINDOJUS-AC | Editar tag</title>
...
<div class="container-fluid">
  <div class="row">
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		...
		<form method="post" action="<?= base_url('editatag/update');?>" >
			<div class="row">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-8">
							<div class="form-group">
								...
								<input type="hidden" id="tagstatus" name="tagstatus" value="<?= $tag['tagstatus']; ?>">
								<input type="text" class="form-control" id="tagname" name="tagname" placeholder="Nome da tag" value="<?= $tag['tagname']; ?>">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<input type="text" class="form-control" id="tagslug" name="tagslug" placeholder="Slug da tag" value="<?= $tag['tagslug']; ?>">
							</div>
						</div>
					</div>
					<button type="submit" class="btn btn-outline-success">Atualizar</button>
					<a class="btn btn-outline-danger" href="<?= base_url('tags'); ?>">Cancelar</a>
				</div>
			</div>
		</form>
    </main>
