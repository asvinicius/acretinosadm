...
<html lang="en">
  <head>
    ...
    <title>SINDOJUS-AC | Início</title>
  ...
  <div class="row">
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
				  <a class="btn btn-block btn-outline-primary" href="<?= base_url('notificacoes'); ?>">Notificações</a>
				</div>
				<div class="col-sm-4">
				  <a class="btn btn-block btn-outline-primary" href="<?= base_url('noticias'); ?>">Notícias</a>
				</div>
				<div class="col-sm-4">
				  <a class="btn btn-block btn-outline-primary" href="<?= base_url('os'); ?>">OS</a>
				</div>
			</div>
			<br />
			<div class="row">
				<div class="col-sm-4">
				  <a class="btn btn-block btn-outline-primary" href="<?= base_url('modelos'); ?>">Modelos</a>
				</div>
				<div class="col-sm-4">
				  <a class="btn btn-block btn-outline-primary" href="<?= base_url('oficios'); ?>">Ofícios</a>
				</div>
				<div class="col-sm-4">
				  <a class="btn btn-block btn-outline-primary" href="<?= base_url('documentos'); ?>">Documentos</a>
				</div>
			</div>
		</div>
    </main>
