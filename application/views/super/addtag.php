...
<html lang="en">
  <head>
    ...
    <title>SINDOJUS-AC | Nova tag</title>
  ...
  <div class="row">
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			<h1 class="h2">Nova tag</h1>
		</div>
		<form method="post" action="<?= base_url('novatag/save');?>" >
			<div class="row">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-8">
							<div class="form-group">
								<input type="text" class="form-control" id="tagname" name="tagname" placeholder="Nome da tag">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<input type="text" class="form-control" id="tagslug" name="tagslug" placeholder="Slug da tag">
							</div>
						</div>
					</div>
