...
<html lang="en">
  <head>
    ...
    <title>SINDOJUS-AC | Nova Notícia</title>
  ...
  <div class="row">
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			<h1 class="h2">Nova Notícia</h1>
		</div>
		<form method="post" action="<?= base_url('novanoticia/save');?>" enctype="multipart/form-data">
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						<input type="text" class="form-control" id="newstitle" name="newstitle" placeholder="Título da notícia">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="newsslug" name="newsslug" placeholder="Slug da notícia">
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="newsfront">Foto principal</label>
								<input type="file" class="form-control-file" id="newsfront" name="newsfront">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="newsthumb">Thumbnail</label>
								<input type="file" class="form-control-file" id="newsthumb" name="newsthumb">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-2">
							...
							<div class="d-block my-2">
								<div class="custom-control custom-radio custom-radio-inline">
									<input id="newstype1" name="newstype" type="radio" class="custom-control-input" value="0">
									<label class="custom-control-label" for="newstype1">Comum</label>
								</div>
								<div class="custom-control custom-radio custom-radio-inline">
									<input id="newstype2" name="newstype" type="radio" class="custom-control-input" value="1">
						...
						<div class="col-sm-3">
							...
							<select class="form-control" name="newscategory" id="newscategory">
								<?php foreach ($categories as $category){ ?>
                                    <option value="<?= $category->categoryid; ?>"> <?php echo $category->categoryname; ?> </option>
                                <?php } ?>
							</select>
						</div>
						<div class="col-sm-7">
					...
					<div class="form-group">
						<textarea class="form-control border-input" id="newsresume" name="newsresume" rows="4" placeholder="Resumo da Notícia" style="resize: none"></textarea>
					</div>
					<textarea name="newscontent" id="newscontent" placeholder="Conteúdo da notícia"></textarea>
					<script>
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" value="1" id="newsdraft" name="newsdraft">
