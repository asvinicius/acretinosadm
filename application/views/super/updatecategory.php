...
<html lang="en">
  <head>
    ...
    <title>SINDOJUS-AC | Editar categoria</title>
...
<div class="container-fluid">
  <div class="row">
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		...
		<form method="post" action="<?= base_url('editacategoria/update');?>" >
			<div class="row">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-8">
							<div class="form-group">
								...
								<input type="hidden" id="categorystatus" name="categorystatus" value="<?= $category['categorystatus']; ?>">
								<input type="text" class="form-control" id="categoryname" name="categoryname" placeholder="Nome da categoria" value="<?= $category['categoryname']; ?>">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<input type="text" class="form-control" id="categoryslug" name="categoryslug" placeholder="Slug da categoria" value="<?= $category['categoryslug']; ?>">
							</div>
						</div>
					</div>
